...
const ProductDetails = () => {
  ...
  const handleImageError = (e) => {
    if (!e.target.src.startsWith("data:")) e.target.src = placeholder;
  };
              ...
              <div className="flex gap-2 overflow-x-auto">
                {images.map((img, idx) => (
                  <button
                    ...
                    className={`w-16 h-16 rounded-lg flex-shrink-0 overflow-hidden border-2 transition ${imageIdx === idx ? "border-green-800" : "border-stone-200"}`}
                  >
                    <img
                      src={img}
                      alt={`Thumb ${idx}`}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 pt-4 border-t border-stone-200">
              ...
              <motion.button
                ...
                className={`w-full py-2.5 rounded-lg font-bold flex items-center justify-center gap-2 text-sm transition ${product?.stock === 0 ? "bg-gray-400 text-white cursor-not-allowed" : "bg-green-800 text-white hover:bg-green-700"}`}
              >
