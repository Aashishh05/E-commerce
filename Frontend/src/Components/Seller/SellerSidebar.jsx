...
const LogoutConfirmModal = ({ isOpen, userName, onConfirm, onCancel }) => {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="bg-gradient-to-br from-red-50 to-red-50/60 px-6 py-6 border-b border-red-100/50">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h2 className="text-lg font-bold text-stone-900">Confirm Logout</h2>
                    <p className="text-sm text-stone-500 mt-1">Are you sure you want to sign out?</p>
                  </div>
                </div>
              </div>

              <div className="px-6 py-5 bg-white">
                <div className="flex items-center gap-3 p-4 rounded-xl bg-green-50/80 border border-green-100/50 mb-1">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-600 to-green-800 text-white text-xs font-bold flex items-center justify-center flex-shrink-0 shadow-md">
                ...
                <p className="text-xs text-stone-500 text-center mt-3">
                  You'll need to sign in again to access your seller portal.
                </p>
              </div>

              <div className="px-6 py-4 bg-stone-50/50 border-t border-stone-100/50 flex gap-3">
                <motion.button
                  whileTap={{ scale: 0.95 }}
                  whileHover={{ backgroundColor: "rgb(241,245,250)" }}
                  onClick={onCancel}
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-white border border-stone-200 text-stone-700 font-semibold text-sm transition-all hover:bg-stone-50 cursor-pointer"
                >
                  <X size={16} />
                  No, Keep Me
                </motion.button>
                <motion.button
                  whileTap={{ scale: 0.95 }}
                  whileHover={{ backgroundColor: "rgb(220,38,38)" }}
                  onClick={onConfirm}
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-red-600 text-white font-semibold text-sm transition-all hover:bg-red-700 shadow-md cursor-pointer"
                >
                  <LogOut size={16} />
                  Yes, Sign Out
                </motion.button>
...
const SellerSidebar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between px-4 h-20 border-b border-stone-100/80 bg-gradient-to-br from-green-50/50 to-transparent">
          ...
          <motion.button
            ...
            className="flex items-center justify-center p-2 rounded-lg text-stone-400 hover:text-stone-600 hover:bg-stone-100/60 transition-all cursor-pointer"
        ...
        <div className="p-3 border-t border-stone-100/80 space-y-2 bg-gradient-to-t from-green-50/30 to-transparent">
          ...
          <motion.button
            ...
            className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl  text-red-600 bg-red-50/60 text-xs font-semibold transition-all cursor-pointer"
          >
