      ...
      >
        <div className="hidden md:flex flex-col justify-between w-[45%] relative overflow-hidden bg-gradient-to-br from-[#223026] via-[#304438] to-[#1F2A22] p-10">
          ...
          <div className="relative z-10">
            <Link to="/">
              <h1 className="text-2xl font-serif text-white tracking-widest font-light">
                AURA
              </h1>
              <p className="uppercase tracking-[0.4em] text-[9px] text-[#C8D3C3] mt-1 font-light">
                Marketplace
              </p>
            </Link>
          </div>
          ...
          <div className="relative z-10 my-auto">
            ...
            <p className="text-[#C8D3C3]/80 leading-relaxed text-xs font-light max-w-xs">
              Join thousands discovering premium products. Fast, secure, and
              delightful.
            </p>
          </div>
          ...
          <div className="relative z-10 flex gap-6 border-t border-white/10 pt-6">
            <div>
              ...
              <p className="text-[9px] text-[#C8D3C3] uppercase tracking-wider mt-1">
                Secure
              </p>
            </div>
            <div>
