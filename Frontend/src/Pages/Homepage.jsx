...
const Homepage = () => {
  ...
  const products = [
    { id: 1, name: "Botanical Face Serum & Jade Roller Set", price: 34.99, originalPrice: 49.99, rating: 4.8, reviewsCount: 120, image: "https://images.unsplash.com/photo-1556228578-8c89e6adf883?w=600&h=600&fit=crop", category: "Beauty", vendorName: "Aura Botanicals", badgeText: "Seller Pick", badgeColor: "green" },
    { id: 2, name: "Handcrafted Cold-Pressed Herbal Oils", price: 19.99, originalPrice: 25.99, rating: 4.9, reviewsCount: 88, image: "https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=600&h=600&fit=crop", category: "Beauty", vendorName: "Aura Botanicals", badgeText: "Trending", badgeColor: "amber" },
    { id: 3, name: "Handspun Organic Linen Summer Kimono", price: 85.0, originalPrice: 110.0, rating: 4.9, reviewsCount: 45, image: "https://images.unsplash.com/photo-1544441893-675973e31985?w=600&h=600&fit=crop", category: "Fashion", vendorName: "Linen & Loom", badgeText: "Limited Edition", badgeColor: "amber" },
    { id: 4, name: "Artisanal Ceramic Coffee Dripper & Mug Set", price: 29.5, originalPrice: 38.0, rating: 4.7, reviewsCount: 62, image: "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=600&h=600&fit=crop", category: "Home", vendorName: "Earthy Pots Co.", badgeText: "Top Selling", badgeColor: "green" },
    { id: 5, name: "Smart Ultrasonic Aromatherapy Humidifier", price: 59.99, originalPrice: 79.99, rating: 4.6, reviewsCount: 154, image: "https://images.unsplash.com/photo-1602928321679-560bb453f190?w=600&h=600&fit=crop", category: "Wellness Tech", vendorName: "Aether Devices", badgeText: "Free Shipping", badgeColor: "green" },
    { id: 6, name: "Natural Bamboo Wireless Phone Charger", price: 39.0, originalPrice: null, rating: 4.5, reviewsCount: 37, image: "https://images.unsplash.com/photo-1622445262465-2481c4574875?w=600&h=600&fit=crop", category: "Electronics", vendorName: "Aether Devices", badgeText: "New", badgeColor: "green" },
    { id: 7, name: "Eco-Conscious Soy Wax Scented Candles (Set of 3)", price: 22.99, originalPrice: 32.0, rating: 4.8, reviewsCount: 198, image: "https://images.unsplash.com/photo-1603006905003-be475563bc59?w=600&h=600&fit=crop", category: "Home", vendorName: "Scented Haven", badgeText: "Hot Deal", badgeColor: "amber" },
    { id: 8, name: "Minimalist Handcrafted Oak Serving Board", price: 45.0, originalPrice: 55.0, rating: 4.9, reviewsCount: 41, image: "https://images.unsplash.com/photo-1574634534894-89d7576c8259?w=600&h=600&fit=crop", category: "Home", vendorName: "Loom & Wood", badgeText: "Artisan Crafted", badgeColor: "green" },
  ];

  const featuredVendors = [
    { name: "Aura Botanicals", type: "Official Store", rating: 4.9, productsCount: 65, logo: "🌿", bannerImage: "https://images.unsplash.com/photo-1559056199-641a0ac8b3f4?w=400&h=200&fit=crop", description: "100% natural botanical skincare & self-care elixirs." },
    { name: "Linen & Loom", type: "Local Artisan", rating: 4.8, productsCount: 42, logo: "🧵", bannerImage: "https://images.unsplash.com/photo-1544441893-675973e31985?w=400&h=200&fit=crop", description: "Slow-fashion garments spun from pure, bio-degradable flax fibers." },
    { name: "Earthy Pots Co.", type: "Verified Studio", rating: 4.7, productsCount: 29, logo: "🏺", bannerImage: "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=400&h=200&fit=crop", description: "Stoneware ceramics handcrafted in wood-fired mountain kilns." },
  ];
  ...
  const filteredProducts = productCategoryTab === "all" ? products : products.filter((p) => p.category.toLowerCase() === productCategoryTab.toLowerCase());
        ...
        >
          ...
          >
            ...
            <motion.div variants={slideUp} className="flex flex-wrap gap-4">
              ...
              <MagneticButton className="px-8 py-3.5 bg-white/10 hover:bg-white/20 text-stone-100 font-semibold rounded-full backdrop-blur-md transition-colors border border-white/30 cursor-pointer"
      ...
      <section className="py-20 bg-gradient-to-br from-green-900 via-green-800 to-green-900 relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.h2 variants={slideUp} className="font-serif text-4xl md:text-5xl font-bold mb-4 leading-tight">
                Join Our Global Network
              </motion.h2>
              <motion.p variants={slideUp} className="text-lg text-green-50 leading-relaxed mb-10">
                Register as a Shopper to collect coupons, or open a Creator Account to list your products globally.
              </motion.p>
              ...
              <div className="flex gap-6 mb-8 border-b border-stone-100 relative">
                {["login", "signup"].map((tab) => (
                  <button
                    ...
                    className={`pb-4 font-bold text-base md:text-lg transition-colors capitalize cursor-pointer relative ${activeTab === tab ? "text-green-800" : "text-stone-400 hover:text-stone-600"}`}
                  >
                  ...
                  >
                    <div>
                      ...
                      <motion.input
                        ...
                        className="w-full px-4 py-3 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-800/20 focus:border-green-800 transition-all text-sm"
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full py-3 bg-green-800 text-white font-bold rounded-xl shadow-md transition-colors cursor-pointer text-sm"
                    >
                      Sign In
                    </motion.button>
                    <p className="text-center text-xs text-stone-500">
                      Need an account?{" "}
                      <button onClick={() => setActiveTab("signup")} className="text-green-800 font-bold hover:underline cursor-pointer">Sign up free</button>
                    </p>
                  </motion.div>
                ) : (
                  <motion.div
                  ...
                  >
                      ...
                      {["First Name", "Last Name"].map((label, i) => (
                        <div key={i}>
                          ...
                          <motion.input
                            ...
                            className="w-full px-4 py-2.5 border border-stone-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-800/20 focus:border-green-800 text-sm"
                            whileFocus={{ scale: 1.01 }}
                          />
                        </div>
                      ))}
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-3 mt-1.5">
                        {["Shopper", "Vendor / Shop"].map((role, i) => (
                          <motion.label
                            key={i}
                            className="flex items-center justify-center gap-2 p-2.5 border border-stone-200 rounded-xl cursor-pointer hover:bg-stone-50 select-none"
                            whileHover={{ scale: 1.02, borderColor: "#166534" }}
                            whileTap={{ scale: 0.98 }}
                          >
                    ...
                    <label className="flex items-start gap-2.5 cursor-pointer pt-2">
                      ...
                      <span className="text-xs text-stone-500 font-medium leading-tight">
                        I agree to the{" "}
                        <a href="#" className="text-green-800 font-bold hover:underline">Aura Buyer Terms</a>{" "}
                        and{" "}
                        <a href="#" className="text-green-800 font-bold hover:underline">Privacy Policy</a>.
                      </span>
                    </label>
                    <motion.button
                      whileHover={{ scale: 1.02, backgroundColor: "#14532d" }}
                      whileTap={{ scale: 0.98 }}
                      className="w-full py-3 bg-green-800 text-white font-bold rounded-xl shadow-md transition-colors cursor-pointer text-sm mt-2"
                    >
                      Create Account
                    </motion.button>
                    <p className="text-center text-xs text-stone-500 pt-1">
                      Already have an account?
                      <button onClick={() => setActiveTab("login")} className="text-green-800 font-bold hover:underline cursor-pointer">Sign in</button>
                    </p>
                  </motion.div>
                )}
              </AnimatePresence>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          >
            ...
            <motion.h2 variants={slideUp} className="font-serif text-4xl font-bold text-stone-900 mt-4 mb-3">
              Subscribe for Eco Voucher Codes
            </motion.h2>

            <motion.p variants={slideUp} className="text-stone-500 text-sm max-w-md mx-auto mb-8">
              Receive $15 off on your first order. Plus, get updates on new local stores, artisan spotlights, and green living.
            </motion.p>
